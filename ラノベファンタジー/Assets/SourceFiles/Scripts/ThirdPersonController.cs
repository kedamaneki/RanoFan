        ...
        private void CameraRotation()
{
    ...
    CinemachineCameraTarget.transform.rotation = Quaternion.Euler(
        ...
        private void Move()
        {
            // 回避中は通常移動を止める（PlayerController が CharacterController を操作する）
            ...
            float weightSpeedMultiplier = ResolveInventoryMovementSpeedMultiplier();
            float targetSpeed = baseSpeed * weightSpeedMultiplier;
            ...
            // 水平方向の移動距離を行動ログに加算
            Vector3 moveDelta = transform.position - positionBeforeMove;
            moveDelta.y = 0f;
            PlayerActionLogger.Instance?.AddMoveDistance(moveDelta.magnitude);
        ...
        /// <summary>InventoryManager の重量負荷率から WASD 移動速度倍率を解決します。</summary>
        private static float ResolveInventoryMovementSpeedMultiplier()
        {
